...
function thread(overrides = {}) {
  return {
    issue: { number: 1, title: 'Login is slow', body: 'It takes eight seconds.', status: 'open', authorName: 'Amit', createdAt: '2026-08-01 09:00:00' },
    canComment: true,
    comments: [
...
function page(t, { data = thread(), response, post, patch } = {}) {
  const sent = [];
