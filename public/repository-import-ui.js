  ...
  return `<section class="card kg-import-panel" id="kg-import-panel">
    ...
    <div class="card-body">
      <form id="kg-import-form">
        ...
        <div class="field"><label><input type="checkbox" name="includeForks" /> Include forks</label><label><input type="checkbox" name="includeArchived" /> Include archived repositories</label><label><input type="checkbox" name="includeIssues" checked /> Bring issues and their comments across (GitHub only)</label><label><input type="checkbox" name="includeLfs" checked /> Fetch Git LFS files, not just their pointers</label></div>
...
function importFormValues() {
  ...
  return {
    ...
    includeLfs: values.has('includeLfs'),
